...
<div class="card shadow">
  ...
  <div class="card-body">
    ...
    <form action="/cash/manager" method="POST" class="needs-validation" novalidate>
      <div class="row">
        ...
        <div class="col-xl-8">
          <div class="form-group pl-3 pt-2">
            <label class="form-check-label px-3">
              <input class="form-check-input" type="radio" name="status" value="<?php echo (intval($row['total']) >= intval($money) ? 2 : 3) ?>" required>
